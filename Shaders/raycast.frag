...
{   float step=.005;
	...
	vec2 backCoord=((varyingVert.xy/varyingVert.w+1)/2.0);//get the screenspace coordinates to lookup the right backface position
	...
	//rayDir=varyingColor.xyz-outLoc.xyz;
...
//		currentColor+=(1-alphaChannel)*sampleColor.rgb*sampleColor.a*3;//no idea about the 3
		currentColor+=(1-alphaChannel)*sampleColor.rgb;//no idea about the 3
